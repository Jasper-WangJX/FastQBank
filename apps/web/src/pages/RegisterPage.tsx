...
// Behavior is unchanged: POST /auth/register → token → redirect to "/".

import { useState, type FormEvent } from "react";
import { Link, useNavigate } from "react-router-dom";
import { Circle, Lock, Mail, Plus } from "lucide-react";
...
export default function RegisterPage() {
  ...
  return (
    <div className="relative flex min-h-dvh flex-col bg-white text-slate-900">
      ...
      {/* Sticky header strip — brand + build tag, plus desktop window
          controls on the right. Whole strip is the drag region in the
          Electron shell. */}
      <header
